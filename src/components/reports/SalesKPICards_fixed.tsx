...
import { formatCurrencyVND, formatNumber } from "@/types/report.types";
  ...
  const cards = [
    {
      ...
      value: formatCurrencyVND(summary.netRevenue),
    ...
    },
    {
      ...
      value: formatCurrencyVND(summary.estimatedProfit),
    ...
    },
    {
      ...
      value: formatCurrencyVND(summary.newDebt),
