...
import { formatCurrency, formatPercentage } from "@/types/finance.types";
import type { FinancialKPI } from "@/types/finance.types";

interface FinancialKPICardsProps {
  data: { kpi: FinancialKPI };
  isLoading?: boolean;
}
...
export default function FinancialKPICards({
  ...
  const cards = [
    ...
    },
    {
      ...
      showWarning: kpi.closingBalance < 50000000, // Warning if < 50M
    },
  ];
