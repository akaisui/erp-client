...
import { InventoryByWarehouseResponse } from "@/types";
...
interface InventoryTableProps {
  inventory: InventoryByWarehouseResponse[];
  isLoading?: boolean;
  onTransfer?: (item: InventoryByWarehouseResponse) => void;
}

export function InventoryTableByWarehouse({
  inventory,
  isLoading = false,
  onTransfer,
}: InventoryTableProps) {
