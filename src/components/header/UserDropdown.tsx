...
export default function UserDropdown() {
  ...
  const handleLogout = () => {
    // useLogout hook handles API call, store clear, and redirect
    logout.mutate();
  };
  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute left-auto right-0 top-full mt-2 flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark -translate-x-0"
      >
        <div>
